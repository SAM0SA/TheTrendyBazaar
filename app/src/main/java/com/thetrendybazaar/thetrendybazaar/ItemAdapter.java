...
public class ItemAdapter extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    public ItemAdapter(Context context, List<Item> items, boolean isClickable) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.listingImage.setImageResource(ImageAdapter.getImageResources(item.articleId)[0]);
